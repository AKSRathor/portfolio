...
const AnyFeedback = () => {
    ...
    const handleOnSendClick = () => {
        ...
        const sendFeedback = async () => {
            ...
            const response = await fetch(`${host}/api/feedback/feedsend`, {
                method: 'POST',
                headers: {
        ...
        <div className='feedBackSenderFinalSection'>
            <div class="sender-area">
                <div class="input-place">
                    <input autocomplete="off" onChange={handleOnFeedChange} placeholder="Send Your Feedback" name='feedback' class="send-input" type="text" />
